...
const offerings = [
  ...
  {
    title: "New Sub-division Development",
    icon: "icon-planning",
  ...
  {
    title: "Agriculture Land and Farm Houses",
  ...
  {
    title: "Commercial Plazas & Land for Development",
  ...
  {
    title: "Environmental Assessment Reports: Phase 1 & Phase 2",
